CREATE TABLE public.sis_usuario (
	...
	, id_usuario_alteracao	BIGINT NOT NULL
	, data_exclusao			TIMESTAMP WITHOUT TIME ZONE NOT NULL
	, id_usuario_exclusao	BIGINT NOT NULL
	, registro_ativo		BOOLEAN NOT NULL
);
ALTER TABLE public.sis_usuario
	ADD CONSTRAINT pk_sis_usuario_id_usuario PRIMARY KEY (id_usuario);
...
ALTER TABLE public.sis_grupo
	ADD CONSTRAINT pk_sis_grupo_id_grupo PRIMARY KEY (id_grupo);
...
ALTER TABLE public.sis_usuario_grupo
	ADD CONSTRAINT pk_sis_usuario_grupo_id_usuario_grupo PRIMARY KEY (id_usuario_grupo);
...
ALTER TABLE public.sis_produto
	ADD CONSTRAINT pk_sis_produto_id_produto PRIMARY KEY (id_produto);
...
ALTER TABLE public.sis_categoria_produto
	ADD CONSTRAINT pk_sis_categoria_produto_id_categoria_produto PRIMARY KEY (id_categoria_produto);
...
ALTER TABLE public.sis_modulo
	ADD CONSTRAINT pk_sis_modulo_id_modulo PRIMARY KEY (id_modulo);
...
ALTER TABLE public.sis_arvore
	ADD CONSTRAINT pk_sis_arvore_id_arvore PRIMARY KEY (id_arvore);

CREATE TABLE public.sis_arvore_modulo (
	id_arvore_modulo		BIGINT NOT NULL
	, id_arvore				BIGINT NOT NULL
    , id_modulo				BIGINT NOT NULL
	, data_inclusao			TIMESTAMP WITHOUT TIME ZONE NOT NULL
	, id_usuario_inclusao	BIGINT NOT NULL
...
ALTER TABLE public.sis_arvore_modulo
	ADD CONSTRAINT pk_sis_arvore_modulo_id_arvore_modulo PRIMARY KEY (id_arvore_modulo);
...
ALTER TABLE public.sis_programa
	ADD CONSTRAINT pk_sis_programa_id_programa PRIMARY KEY (id_programa);

CREATE TABLE public.sis_programa_arvore (
	id_programa_arvore		BIGINT NOT NULL
	, id_programa			BIGINT NOT NULL
	, id_arvore				BIGINT NOT NULL
	, data_inclusao			TIMESTAMP WITHOUT TIME ZONE NOT NULL
	, id_usuario_inclusao	BIGINT NOT NULL
...
ALTER TABLE public.sis_programa_arvore
	ADD CONSTRAINT pk_sis_programa_arvore_id_programa_arvore PRIMARY KEY (id_programa_arvore);

CREATE TABLE public.sis_usuario_programa (
	id_usuario_programa		BIGINT NOT NULL
	, id_usuario			BIGINT NOT NULL
	, id_programa			BIGINT NOT NULL
	, data_inclusao			TIMESTAMP WITHOUT TIME ZONE NOT NULL
	, id_usuario_inclusao	BIGINT NOT NULL
...
ALTER TABLE public.sis_usuario_programa
	ADD CONSTRAINT pk_sis_usuario_programa_id_usuario_programa PRIMARY KEY (id_usuario_programa);

CREATE TABLE public.sis_grupo_programa (
	id_grupo_programa		BIGINT NOT NULL
	, id_grupo				BIGINT NOT NULL
	, id_programa			BIGINT NOT NULL
	, data_inclusao			TIMESTAMP WITHOUT TIME ZONE NOT NULL
	, id_usuario_inclusao	BIGINT NOT NULL
...
ALTER TABLE public.sis_grupo_programa
	ADD CONSTRAINT pk_sis_grupo_programa_id_grupo_programa PRIMARY KEY (id_grupo_programa);
...
ALTER TABLE public.sis_unidade_medida
	ADD CONSTRAINT pk_sis_unidade_medida_id_unidade_medida PRIMARY KEY (id_unidade_medida);
